...
class Paths():
    def __init__(self):
        ...
        self.special_paths = {
                ...
                'rrfs_noah_mp': {
                    'data_dir': f"/lfs/h2/emc/vpppg/noscrub/marcel.caron/{os.environ['NET']}_rrfs_noah_mp/{os.environ['evs_ver_2d']}/stats/{os.environ['COMPONENT']}",
                    'file_template': '',
                },
        }
...
class ModelSpecs():
    def __init__(self):
        ...
        self.model_alias = {
            ...
            'rrfs_noah_mp': {
                'settings_key':'RRFS_NOAH_MP', 
                'stats_key':'rrfs',
                'plot_name':'RRFS Noah-MP'
            },
            'RRFS_A_AK': {
                'settings_key':'RRFS_A', 
                'stats_key':'',
