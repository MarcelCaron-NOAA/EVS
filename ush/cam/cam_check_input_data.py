...
if proceed:
    ...
    if STEP == 'stats':
        ...
        elif 'arefsmem' in MODELNAME:
            COMINfcst = os.environ['COMINarefsmem']
            mem = os.environ['mem']
        else:
            ...
            if 'ctl' in MODELNAME:
                ...
                if NEST == 'conus':
                    fcst_templates.append(os.path.join(
                        ...
                        '{IHOUR}',
                        f'm00{mem}',
                        'arafs.t{IHOUR}z.'+f'm00{mem}.'+'prslev.3km.f0{FHR}.conus.grib2'
                    ))
                elif NEST == 'ak':
                    fcst_templates.append(os.path.join(
                        COMINfcst, 
                        ...
                        '{IHOUR}',
                        f'm00{mem}',
                        'arafs.t{IHOUR}z.'+f'm00{mem}.'+'prslev.3km.f0{FHR}.ak.grib2'
                    ))
                elif NEST == 'hi':
                    fcst_templates.append(os.path.join(
                        COMINfcst, 
                        ...
                        '{IHOUR}',
                        f'm00{mem}',
                        'arafs.t{IHOUR}z.'+f'm00{mem}.'+'prslev.2p5km.f0{FHR}.hi.grib2'
                    ))
                elif NEST == 'pr':
                    fcst_templates.append(os.path.join(
                        COMINfcst, 
                        ...
                        '{IHOUR}',
                        f'm00{mem}',
                        'arafs.t{IHOUR}z.'+f'm00{mem}.'+'prslev.2p5km.f0{FHR}.pr.grib2'
                    ))
                else:
                    fcst_templates.append(os.path.join(
                        COMINfcst, 
