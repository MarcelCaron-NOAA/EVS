#!/usr/bin/env python3
"""
cam_plots_grid2obs_graphx_defs.py
CONTRIBUTORS: Marcel Caron, marcel.caron@noaa.gov, NOAA/NWS/NCEP/EMC-VPPPGB
----------------------
Graphics definitions for the CAM Grid2Obs Plots jobs, used by the cam
component for grid-to-observation plotting and job configuration.

Environment Variables (Inputs):
    EVAL_PERIOD (used within graphics definitions)

Outputs:
    - Provides the 'graphics' dictionary for CAM Grid2Obs plotting jobs.

This module is intended to be imported and used as part of the cam component's
plotting and job generation workflow for grid-to-observation plots.
"""
