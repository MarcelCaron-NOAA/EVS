                ...
                for fhr in $fhrs; do
                    ...
                    if [ ! -e  $COMOUTrestart/${prod}/run_refs_precip_${prod}.${obsv}.f${fhr}.v${vhr}.completed ] ; then
                        ...
                        if [ -s $input_fcst ] && [ -s $input_obsv ] ; then 
                            ...
                            echo  "export output_base=$WORK/precip/run_refs_precip_${prod}.${obsv}.f${fhr}.v${vhr}" >> run_refs_precip_${prod}.${obsv}.f${fhr}.v${vhr}.sh
                            ...
                            if [ $obsv = ccpa01h ]  ; then
                                ...
                                if [ $prod = system ] ; then
                                    ...
                                    echo  "export modelpath=$COMREFS" >> run_refs_precip_${prod}.${obsv}.f${fhr}.v${vhr}.sh
                                    echo  "export modeltail='.conus.grib2'" >> run_refs_precip_${prod}.${obsv}.f${fhr}.v${vhr}.sh
                                ...
                                if [ $prod = system ] ; then
                                    ...
                                    echo  "export modelhead=refs" >> run_refs_precip_${prod}.${obsv}.f${fhr}.v${vhr}.sh
                                    echo  "export modelpath=$COMREFS" >> run_refs_precip_${prod}.${obsv}.f${fhr}.v${vhr}.sh
                                    echo  "export modeltail='.ak.grib2'" >> run_refs_precip_${prod}.${obsv}.f${fhr}.v${vhr}.sh
                                    echo  "export extradir='ensprod/'" >> run_refs_precip_${prod}.${obsv}.f${fhr}.v${vhr}.sh
                                fi
                            ...
                            if [ $prod = prob ] || [ $prod = eas ] ; then
                                ...
                                if [ $obsvtype = ccpa ] ; then
                                    ...
                                    echo "  export err=\$?; err_chk" >> run_refs_precip_${prod}.${obsv}.f${fhr}.v${vhr}.sh
                                    ...
                                    echo "if [ -s $WORK/${obsvtype}.${VDATE}/${obsv}.t${vhr}z.G255.nc ] ; then " >> run_refs_precip_${prod}.${obsv}.f${fhr}.v${vhr}.sh
                                    ...
                                    echo " export err=\$?; err_chk" >> run_refs_precip_${prod}.${obsv}.f${fhr}.v${vhr}.sh
                                    echo "fi" >> run_refs_precip_${prod}.${obsv}.f${fhr}.v${vhr}.sh
                                fi
                                ...
                                if [ $obsvtype = ccpa ] ; then
                                    ...
                                    echo "if [ -s $WORK/${obsvtype}.${VDATE}/${obsv}.t${vhr}z.G216.nc ] ; then " >> run_refs_precip_${prod}.${obsv}.f${fhr}.v${vhr}.sh
                                    ...
                                    echo "fi" >> run_refs_precip_${prod}.${obsv}.f${fhr}.v${vhr}.sh
                                    echo "if [ -s $WORK/${obsvtype}.${VDATE}/${obsv}.t${vhr}z.G91.nc ] ; then " >> run_refs_precip_${prod}.${obsv}.f${fhr}.v${vhr}.sh
                                    echo " export err=\$?; err_chk" >> run_refs_precip_${prod}.${obsv}.f${fhr}.v${vhr}.sh
                            ...
                            echo "if [ -s \$output_base/stat/${MODEL}/*_stat_${MODEL}_${obsv}_G*_${fhr}0000L_${VDATE}_${vhr}0000V.stat ] ; then" >> run_refs_precip_${prod}.${obsv}.f${fhr}.v${vhr}.sh
                            echo "  cp \$output_base/stat/${MODEL}/*_stat_${MODEL}_${obsv}_G*_${fhr}0000L_${VDATE}_${vhr}0000V.stat $all_stats/${MODEL}" >> run_refs_precip_${prod}.${obsv}.f${fhr}.v${vhr}.sh
                            echo "  echo completed >\$output_base/stat/${MODEL}/run_refs_precip_${prod}.${obsv}.f${fhr}.v${vhr}.completed" >> run_refs_precip_${prod}.${obsv}.f${fhr}.v${vhr}.sh
                            echo "fi" >> run_refs_precip_${prod}.${obsv}.f${fhr}.v${vhr}.sh


                            #Copy files to COMOUT:
                            echo "if [ $SENDCOM = YES ] ; then" >> run_refs_precip_${prod}.${obsv}.f${fhr}.v${vhr}.sh 
                            echo " if [ -s $all_stats/${MODEL}/*_stat_${MODEL}_${obsv}_G*_${fhr}0000L_${VDATE}_${vhr}0000V.stat ] ; then" >> run_refs_precip_${prod}.${obsv}.f${fhr}.v${vhr}.sh
                            echo "	 cp \$output_base/stat/${MODEL}/run_refs_precip_${prod}.${obsv}.f${fhr}.v${vhr}.completed $COMOUTrestart/${prod}/run_refs_precip_${prod}.${obsv}.f${fhr}.v${vhr}.completed" >> run_refs_precip_${prod}.${obsv}.f${fhr}.v${vhr}.sh 
                            echo "   cp $all_stats/${MODEL}/*_stat_${MODEL}_${obsv}_G*_${fhr}0000L_${VDATE}_${vhr}0000V.stat $COMOUTsmall/${MODEL}" >> run_refs_precip_${prod}.${obsv}.f${fhr}.v${vhr}.sh
                            echo " fi" >> run_refs_precip_${prod}.${obsv}.f${fhr}.v${vhr}.sh
                            echo "fi" >> run_refs_precip_${prod}.${obsv}.f${fhr}.v${vhr}.sh

                            chmod +x run_refs_precip_${prod}.${obsv}.f${fhr}.v${vhr}.sh
                            echo "${DATA}/scripts/run_refs_precip_${prod}.${obsv}.f${fhr}.v${vhr}.sh" >> run_all_refs_precip_poe.sh
...
done # end of obs_type
chmod 775 run_all_refs_precip_poe.sh
