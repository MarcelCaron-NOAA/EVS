    ...
    'cam':{
        'precip':{
            ...
            'mrms':{
                ...
                'domain_group2, fhr_group1, init_group2, namnest, rrfs, hireswarw, hireswarwmem2, hireswfv3':{
                    'spatial_map':{
                        'DATE_TYPE':'VALID',
                        'VALID_BEG':'',
                        'VALID_END': (datetime.strptime(os.environ['VDATE'], '%Y%m%d')-td(days=1)).strftime('%Y%m%d'),
                ...
                'domain_group2, fhr_group2, init_group2, namnest, rrfs, hireswfv3':{
                    'spatial_map':{
                        'DATE_TYPE':'VALID',
                        'VALID_BEG':'',
                        'VALID_END': (datetime.strptime(os.environ['VDATE'], '%Y%m%d')-td(days=1)).strftime('%Y%m%d'),
                ...
                'domain_group3, fhr_group1, init_group1, namnest, rrfs, hireswarw, hireswarwmem2, hireswfv3':{
                    'spatial_map':{
                        'DATE_TYPE':'VALID',
                        'VALID_BEG':'',
                        'VALID_END': (datetime.strptime(os.environ['VDATE'], '%Y%m%d')-td(days=1)).strftime('%Y%m%d'),
