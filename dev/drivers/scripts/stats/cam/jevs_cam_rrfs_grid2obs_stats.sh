#PBS -S /bin/bash
#PBS -N jevs_cam_rrfs_grid2obs_stats
#PBS -j oe
#PBS -S /bin/bash
#PBS -q dev
#PBS -A VERF-DEV
...
export SENDDBN=NO
export SENDDBN_NTC=
export job=${PBS_JOBNAME:-jevs_cam_rrfs_grid2obs_stats}
...
export COMIN=/lfs/h2/emc/vpppg/noscrub/$USER/${NET}_rrfs_noah_mp/$evs_ver_2d
