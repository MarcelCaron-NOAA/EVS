...
# =============================================================================
#
# NAME: exevs_stats_arefsmem_snowfall.sh
# CONTRIBUTOR(S): Marcel Caron, marcel.caron@noaa.gov, NOAA/NWS/NCEP/EMC-VPPPGB
# PURPOSE: Handle all components of an EVS AREFS Member Snowfall - Statistics 
#          job
...
# Run All AREFS Member snowfall/stats Reformat Jobs
...
# Run All AREFS Member snowfall/stats Generate Jobs
chmod u+x ${DATA}/${VERIF_CASE}/METplus_job_scripts/${job_type}/*
ncount_job=$(ls -l ${DATA}/${VERIF_CASE}/METplus_job_scripts/${job_type}/job* 2>/dev/null |wc -l)
nc=1
if [ $USE_CFP = YES ]; then
...
# Run All AREFS Member snowfall/stats Gather Jobs
chmod u+x ${DATA}/${VERIF_CASE}/METplus_job_scripts/${job_type}/*
ncount_job=$(ls -l ${DATA}/${VERIF_CASE}/METplus_job_scripts/${job_type}/job* 2>/dev/null |wc -l)
nc=1
if [ $USE_CFP = YES ]; then
